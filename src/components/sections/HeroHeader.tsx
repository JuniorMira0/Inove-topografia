...
const desktopBackgroundImages = [
    { src: '/images/hero-background.webp', alt: 'Topógrafo em campo aberto com montanhas' },
    { src: '/images/hero-background-2.webp', alt: 'Equipamento de topografia em detalhe ao pôr do sol' },
    { src: '/images/hero-background-3.webp', alt: 'Drone sobrevoando área de mineração' },
];

// Lista de imagens para MOBILE (formato retrato)
const mobileBackgroundImages = [
    { src: '/images/hero-mobile-1.webp', alt: 'Topógrafo trabalhando visto de perto' },
    { src: '/images/hero-mobile-2.webp', alt: 'Detalhe de um drone em operação' },
    { src: '/images/hero-mobile-3.webp', alt: 'Vista vertical de uma ferrovia em construção' },
];
